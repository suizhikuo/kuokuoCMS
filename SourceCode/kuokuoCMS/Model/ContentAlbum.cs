...
namespace Model
{
    ...
    public partial class ContentAlbum
    {
        public ContentAlbum()
        {
            this.ContentAlbumPictures = new HashSet<ContentAlbumPicture>();
        ...
        public virtual ICollection<ContentAlbumPicture> ContentAlbumPictures { get; set; }
